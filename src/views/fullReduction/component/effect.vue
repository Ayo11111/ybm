 ...
 * @LastEditors: CJH
 * @LastEditTime: 2021-08-30 17:31:33
-->
<template>
  <div>
    ...
    <b>活动效果数据</b>
    <div class="infoBox">
      <div v-for="(item, index) in info" :key="index" v-loading="statsLoad" class="item">
  ...
  methods: {
    ...
    selcetTime(day) {
      ...
      if (day !== 0) {
        ...
        startTime = moment().subtract(day, 'days').format('YYYY-MM-DD 00:00:00')
